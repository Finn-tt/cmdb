...
class Asset(models.Model):
    ...
    manufacturer = models.ForeignKey('Manufacturer', unique=True, blank=True, verbose_name="制造商")
    ...
    idc = models.ForeignKey('IDC', null=True, blank=True, verbose_name="机房")
    ...
    approved_by = models.ForeignKey(null=True, blank=True, verbose_name="批准人", related_name='approved_by')

    memo = models.TextField(null=True, blank=True, verbose_name="备注")
    c_time = models.DateField(auto_now_add=True, verbose_name="批准日期")
...
class Server(models.Model):
    ...
    create_by = models.CharField(choices=create_by_choice, default='auto', verbose_name="添加方式")
    host_on = models.ForeignKey('self', related_name='host_on_server', blank=True, null=True, verbose_name="宿主机")
    ...
    os_type = models.CharField('操作类型', max_length=64, null=True, blank=True)
...
class RAM(models.Model):
    ...
    sn = models.CharField('SN号', max_length=128, null=True, blank=True)
    model = models.CharField('内存型号', max_length=128, null=True, blank=True)
    slot = models.CharField('插槽',max_length=64)
    capacity = models.IntegerField('内存大小(GB)', null=True, blank=True)
